...
public class FlightZoneMapWidgetViewModel : MapWidgetBase
{
    ...
    public FlightZoneMapWidgetViewModel()
        : base(new Uri(UriString)) { }

    [ImportingConstructor]
    public FlightZoneMapWidgetViewModel(ILocalizationService loc)
        : this()
    {
        _loc = loc;
        ...
        RemoveSelectedAnchor = ReactiveCommand.Create(
            () => _flightZoneMap.FlightZoneAnchors.Remove(Map.SelectedItem)
        );
    }
